...
main(int argc, char *argv[])
{
  ...
  14:	e8 aa 04 00 00       	call   4c3 <getreadcount>
  ...
  1d:	89 c6                	mov    %eax,%esi
	printf(1, "Read count  %d\n", rc1);
  1f:	68 c8 08 00 00       	push   $0x8c8
  24:	6a 01                	push   $0x1
  26:	e8 75 05 00 00       	call   5a0 <printf>
	int rc = fork();
  2b:	e8 eb 03 00 00       	call   41b <fork>
	if (rc < 0) {
  30:	83 c4 10             	add    $0x10,%esp
  33:	85 c0                	test   %eax,%eax
  35:	78 5e                	js     95 <main+0x95>
  ...
  3a:	57                   	push   %edi
  3b:	6a 05                	push   $0x5
  3d:	68 e6 08 00 00       	push   $0x8e6
  42:	e8 29 01 00 00       	call   170 <readfile>
	if (rc > 0) {
  47:	83 c4 10             	add    $0x10,%esp
  4a:	85 db                	test   %ebx,%ebx
  4c:	74 42                	je     90 <main+0x90>
		wait();
  4e:	e8 d8 03 00 00       	call   42b <wait>
		int rc2 = getreadcount();
  53:	e8 6b 04 00 00       	call   4c3 <getreadcount>
		printf(1, "Read count  %d\n", rc2);
  58:	51                   	push   %ecx
		int rc2 = getreadcount();
  ...
  5b:	50                   	push   %eax
		assert((rc2 - rc1) == 10);
  5c:	29 f3                	sub    %esi,%ebx
		printf(1, "Read count  %d\n", rc2);
  5e:	68 c8 08 00 00       	push   $0x8c8
  63:	6a 01                	push   $0x1
  65:	e8 36 05 00 00       	call   5a0 <printf>
		assert((rc2 - rc1) == 10);
  6a:	83 c4 10             	add    $0x10,%esp
  6d:	83 fb 0a             	cmp    $0xa,%ebx
  70:	74 36                	je     a8 <main+0xa8>
  72:	83 ec 0c             	sub    $0xc,%esp
  75:	6a 24                	push   $0x24
  77:	68 ed 08 00 00       	push   $0x8ed
  7c:	68 fb 08 00 00       	push   $0x8fb
			exit();
		}
		close(fd1);
  ...
  90:	e8 8e 03 00 00       	call   423 <exit>
		printf(1, "Fork failed!\n");
  95:	50                   	push   %eax
  96:	50                   	push   %eax
  97:	68 d8 08 00 00       	push   $0x8d8
  9c:	6a 01                	push   $0x1
  9e:	e8 fd 04 00 00       	call   5a0 <printf>
		exit();
  a3:	e8 7b 03 00 00       	call   423 <exit>
		printf(1, "TEST PASSED\n");
  a8:	51                   	push   %ecx
  a9:	51                   	push   %ecx
  aa:	68 25 09 00 00       	push   $0x925
  af:	6a 01                	push   $0x1
  b1:	e8 ea 04 00 00       	call   5a0 <printf>
		int fd1 = open("ls", 0);
  b6:	5b                   	pop    %ebx
  b7:	5e                   	pop    %esi
  b8:	6a 00                	push   $0x0
  ba:	68 32 09 00 00       	push   $0x932
  bf:	e8 9f 03 00 00       	call   463 <open>
  ...
  c7:	58                   	pop    %eax
  c8:	6a 00                	push   $0x0
  ca:	68 35 09 00 00       	push   $0x935
  cf:	e8 8f 03 00 00       	call   463 <open>
  d4:	89 c7                	mov    %eax,%edi
		int fd3 = open("cat", 0);
  d6:	58                   	pop    %eax
  d7:	5a                   	pop    %edx
  d8:	6a 00                	push   $0x0
  da:	68 41 09 00 00       	push   $0x941
  df:	e8 7f 03 00 00       	call   463 <open>
		if(fd1 * fd2 * fd3 < 0){
  ...
  eb:	0f af c7             	imul   %edi,%eax
  ee:	0f af c6             	imul   %esi,%eax
  f1:	85 c0                	test   %eax,%eax
  f3:	78 65                	js     15a <main+0x15a>
		close(fd1);
  f5:	83 ec 0c             	sub    $0xc,%esp
  f8:	53                   	push   %ebx
  f9:	e8 4d 03 00 00       	call   44b <close>
		int of = getopenfilecount();
  fe:	e8 c8 03 00 00       	call   4cb <getopenfilecount>
		printf(1, "Number of opened files %d\n", of - 3);
 103:	83 c4 0c             	add    $0xc,%esp
		int of = getopenfilecount();
 106:	89 c3                	mov    %eax,%ebx
		printf(1, "Number of opened files %d\n", of - 3);
 108:	8d 40 fd             	lea    -0x3(%eax),%eax
 10b:	50                   	push   %eax
 10c:	68 53 09 00 00       	push   $0x953
 111:	6a 01                	push   $0x1
 113:	e8 88 04 00 00       	call   5a0 <printf>
		assert(of == 5);
 118:	83 c4 10             	add    $0x10,%esp
 11b:	83 fb 05             	cmp    $0x5,%ebx
 11e:	74 14                	je     134 <main+0x134>
 120:	83 ec 0c             	sub    $0xc,%esp
 123:	6a 30                	push   $0x30
 125:	68 ed 08 00 00       	push   $0x8ed
 12a:	68 6e 09 00 00       	push   $0x96e
 12f:	e9 4d ff ff ff       	jmp    81 <main+0x81>
		printf(1, "TEST PASSED\n");
 134:	50                   	push   %eax
 135:	50                   	push   %eax
 136:	68 25 09 00 00       	push   $0x925
 13b:	6a 01                	push   $0x1
 13d:	e8 5e 04 00 00       	call   5a0 <printf>
		close(fd2);
 142:	89 3c 24             	mov    %edi,(%esp)
 145:	e8 01 03 00 00       	call   44b <close>
		close(fd3);
 14a:	89 34 24             	mov    %esi,(%esp)
 14d:	e8 f9 02 00 00       	call   44b <close>
 152:	83 c4 10             	add    $0x10,%esp
	}
	exit();
 155:	e9 36 ff ff ff       	jmp    90 <main+0x90>
			printf(1, "Open failed!\n");
 15a:	52                   	push   %edx
 15b:	52                   	push   %edx
 15c:	68 45 09 00 00       	push   $0x945
 161:	6a 01                	push   $0x1
 163:	e8 38 04 00 00       	call   5a0 <printf>
			exit();
...
void readfile(char *file, int howmany) {
 ...
 174:	56                   	push   %esi
 175:	53                   	push   %ebx
 176:	83 ec 24             	sub    $0x24,%esp
	int fd = open(file, 0);
 179:	6a 00                	push   $0x0
 17b:	ff 75 08             	push   0x8(%ebp)
 17e:	e8 e0 02 00 00       	call   463 <open>
	for (i = 0; i < howmany; i++)
 ...
 18d:	7e 20                	jle    1af <readfile+0x3f>
 18f:	31 f6                	xor    %esi,%esi
 191:	8d 7d e7             	lea    -0x19(%ebp),%edi
 ...
 1a0:	57                   	push   %edi
 1a1:	53                   	push   %ebx
 1a2:	e8 94 02 00 00       	call   43b <read>
	for (i = 0; i < howmany; i++)
 1a7:	83 c4 10             	add    $0x10,%esp
 1aa:	39 75 0c             	cmp    %esi,0xc(%ebp)
 1ad:	75 e9                	jne    198 <readfile+0x28>
	close(fd);
 1af:	83 ec 0c             	sub    $0xc,%esp
 1b2:	53                   	push   %ebx
 1b3:	e8 93 02 00 00       	call   44b <close>
}
 ...
 4fc:	89 d1                	mov    %edx,%ecx
{
 ...
 529:	0f b6 92 d8 09 00 00 	movzbl 0x9d8(%edx),%edx
 ...
 5a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 619:	ff 24 85 80 09 00 00 	jmp    *0x980(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 727:	90                   	nop
          s = "(null)";
 728:	ba 76 09 00 00       	mov    $0x976,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 741:	a1 b8 0c 00 00       	mov    0xcb8,%eax
{
 ...
 781:	5b                   	pop    %ebx
  freep = p;
 782:	89 15 b8 0c 00 00    	mov    %edx,0xcb8
}
 788:	5e                   	pop    %esi
 789:	5f                   	pop    %edi
 78a:	5d                   	pop    %ebp
 ...
 7b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7bc:	89 15 b8 0c 00 00    	mov    %edx,0xcb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7dc:	8b 3d b8 0c 00 00    	mov    0xcb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 81f:	73 4f                	jae    870 <malloc+0xa0>
    ...
    if(p == freep)
 821:	8b 3d b8 0c 00 00    	mov    0xcb8,%edi
 ...
 84a:	e8 f1 fe ff ff       	call   740 <free>
  return freep;
 84f:	8b 15 b8 0c 00 00    	mov    0xcb8,%edx
 ...
 87c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 87f:	89 15 b8 0c 00 00    	mov    %edx,0xcb8
}
