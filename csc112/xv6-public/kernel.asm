...
80100028:	bc a0 60 11 80       	mov    $0x801160a0,%esp
...
80102088:	68 ae 7c 10 80       	push   $0x80107cae
...
801024d2:	81 fb a0 60 11 80    	cmp    $0x801160a0,%ebx
...
80103077:	68 a0 60 11 80       	push   $0x801160a0
...
801037ee:	83 ec 0c             	sub    $0xc,%esp
	p->tickets = 10;
801037f1:	c7 43 7c 0a 00 00 00 	movl   $0xa,0x7c(%ebx)
	p->ticks = 0;
...
80103805:	8d 50 01             	lea    0x1(%eax),%edx
  p->state = EMBRYO;
80103808:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  release(&ptable.lock);
8010380f:	68 20 1d 11 80       	push   $0x80111d20
  p->pid = nextpid++;
80103814:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
8010381a:	e8 21 0e 00 00       	call   80104640 <release>
...
8010383c:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010383f:	c7 40 14 37 5a 10 80 	movl   $0x80105a37,0x14(%eax)
  p->context = (struct context*)sp;
...
8010384e:	e8 0d 0f 00 00       	call   80104760 <memset>
...
8010387a:	e8 c1 0d 00 00       	call   80104640 <release>
}
...
801039d3:	e8 58 36 00 00       	call   80107030 <setupkvm>
...
801039eb:	68 64 a4 10 80       	push   $0x8010a464
801039f0:	50                   	push   %eax
801039f1:	e8 ea 32 00 00       	call   80106ce0 <inituvm>
...
80103a06:	e8 55 0d 00 00       	call   80104760 <memset>
...
80103a5f:	68 d0 7a 10 80       	push   $0x80107ad0
80103a64:	50                   	push   %eax
80103a65:	e8 b6 0e 00 00       	call   80104920 <safestrcpy>
  p->cwd = namei("/");
80103a6a:	c7 04 24 d9 7a 10 80 	movl   $0x80107ad9,(%esp)
...
80103aa3:	68 b7 7a 10 80       	push   $0x80107ab7
...
80103adb:	e8 f0 30 00 00       	call   80106bd0 <switchuvm>
  return 0;
...
80103afa:	e8 51 33 00 00       	call   80106e50 <allocuvm>
...
80103b1a:	e8 61 34 00 00       	call   80106f80 <deallocuvm>
...
80103b68:	e8 b3 35 00 00       	call   80107120 <copyuvm>
...
80103c74:	bf 60 1d 11 80       	mov    $0x80111d60,%edi
80103c79:	68 20 1d 11 80       	push   $0x80111d20
80103c7e:	e8 1d 0a 00 00       	call   801046a0 <acquire>
    for(i = 0; i < NPROC; i++){
80103c83:	83 c4 10             	add    $0x10,%esp
    acquire(&ptable.lock);
80103c86:	89 f8                	mov    %edi,%eax
    mt = 0;
80103c88:	31 d2                	xor    %edx,%edx
80103c8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->state != RUNNABLE)
80103c90:	83 38 03             	cmpl   $0x3,(%eax)
80103c93:	75 03                	jne    80103c98 <scheduler+0x48>
      mt += p->tickets;
80103c95:	03 50 70             	add    0x70(%eax),%edx
    for(i = 0; i < NPROC; i++){
80103c98:	05 84 00 00 00       	add    $0x84,%eax
80103c9d:	3d 60 3e 11 80       	cmp    $0x80113e60,%eax
80103ca2:	75 ec                	jne    80103c90 <scheduler+0x40>
    rt = random_at_most(mt);
80103ca4:	83 ec 0c             	sub    $0xc,%esp
80103ca7:	52                   	push   %edx
80103ca8:	e8 73 38 00 00       	call   80107520 <random_at_most>
80103cad:	83 c4 10             	add    $0x10,%esp
    ct = 0;
80103cb0:	31 c9                	xor    %ecx,%ecx
    for(i = 0; i < NPROC; i++){
80103cb2:	31 d2                	xor    %edx,%edx
      if(p->state != RUNNABLE)
80103cb4:	83 3f 03             	cmpl   $0x3,(%edi)
80103cb7:	75 6f                	jne    80103d28 <scheduler+0xd8>
   		ct += p->tickets;
80103cb9:	03 4f 70             	add    0x70(%edi),%ecx
   		if(ct<=rt)
80103cbc:	39 c8                	cmp    %ecx,%eax
80103cbe:	7d 68                	jge    80103d28 <scheduler+0xd8>
    	p = &ptable.proc[i];
80103cc0:	69 fa 84 00 00 00    	imul   $0x84,%edx,%edi
      switchuvm(p);
80103cc6:	83 ec 0c             	sub    $0xc,%esp
    	p = &ptable.proc[i];
80103cc9:	8d 87 54 1d 11 80    	lea    -0x7feee2ac(%edi),%eax
      c->proc = p;
80103ccf:	89 83 ac 00 00 00    	mov    %eax,0xac(%ebx)
      switchuvm(p);
80103cd5:	50                   	push   %eax
80103cd6:	e8 f5 2e 00 00       	call   80106bd0 <switchuvm>
      p->state = RUNNING;
80103cdb:	8d 87 20 1d 11 80    	lea    -0x7feee2e0(%edi),%eax
80103ce1:	c7 87 60 1d 11 80 04 	movl   $0x4,-0x7feee2a0(%edi)
80103ce8:	00 00 00 
      p->ticks += 1;
80103ceb:	83 80 b4 00 00 00 01 	addl   $0x1,0xb4(%eax)
      swtch(&(c->scheduler), p->context);
80103cf2:	5a                   	pop    %edx
80103cf3:	59                   	pop    %ecx
80103cf4:	ff 70 50             	push   0x50(%eax)
80103cf7:	56                   	push   %esi
80103cf8:	e8 7e 0c 00 00       	call   8010497b <swtch>
      switchkvm();
80103cfd:	e8 be 2e 00 00       	call   80106bc0 <switchkvm>
      break;
80103d02:	83 c4 10             	add    $0x10,%esp
      c->proc = 0;
80103d05:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103d0c:	00 00 00 
    release(&ptable.lock);
80103d0f:	83 ec 0c             	sub    $0xc,%esp
80103d12:	68 20 1d 11 80       	push   $0x80111d20
80103d17:	e8 24 09 00 00       	call   80104640 <release>
    sti();
80103d1c:	83 c4 10             	add    $0x10,%esp
80103d1f:	e9 4c ff ff ff       	jmp    80103c70 <scheduler+0x20>
80103d24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for(i = 0; i < NPROC; i++){
80103d28:	83 c2 01             	add    $0x1,%edx
80103d2b:	81 c7 84 00 00 00    	add    $0x84,%edi
80103d31:	83 fa 40             	cmp    $0x40,%edx
80103d34:	0f 85 7a ff ff ff    	jne    80103cb4 <scheduler+0x64>
80103d3a:	eb d3                	jmp    80103d0f <scheduler+0xbf>
...
80103d44:	53                   	push   %ebx
  pushcli();
80103d45:	e8 06 08 00 00       	call   80104550 <pushcli>
  c = mycpu();
80103d4a:	e8 c1 fb ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103d4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d55:	e8 46 08 00 00       	call   801045a0 <popcli>
  if(!holding(&ptable.lock))
80103d5a:	83 ec 0c             	sub    $0xc,%esp
80103d5d:	68 20 1d 11 80       	push   $0x80111d20
80103d62:	e8 99 08 00 00       	call   80104600 <holding>
80103d67:	83 c4 10             	add    $0x10,%esp
80103d6a:	85 c0                	test   %eax,%eax
80103d6c:	74 4f                	je     80103dbd <sched+0x7d>
  if(mycpu()->ncli != 1)
80103d6e:	e8 9d fb ff ff       	call   80103910 <mycpu>
...
80103d91:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d97:	e8 74 fb ff ff       	call   80103910 <mycpu>
80103d9c:	83 ec 08             	sub    $0x8,%esp
80103d9f:	ff 70 04             	push   0x4(%eax)
80103da2:	53                   	push   %ebx
80103da3:	e8 d3 0b 00 00       	call   8010497b <swtch>
  mycpu()->intena = intena;
80103da8:	e8 63 fb ff ff       	call   80103910 <mycpu>
}
...
80103e06:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103e09:	e8 82 fb ff ff       	call   80103990 <myproc>
  if(curproc == initproc)
80103e0e:	39 05 54 3e 11 80    	cmp    %eax,0x80113e54
...
80103e6a:	e8 31 08 00 00       	call   801046a0 <acquire>
...
80103e85:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
...
80103e97:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e9e:	05 84 00 00 00       	add    $0x84,%eax
80103ea3:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103ea8:	75 e2                	jne    80103e8c <exit+0x8c>
      p->parent = initproc;
80103eaa:	8b 0d 54 3e 11 80    	mov    0x80113e54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103eb0:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
80103eb5:	eb 17                	jmp    80103ece <exit+0xce>
80103eb7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103ebe:	66 90                	xchg   %ax,%ax
80103ec0:	81 c2 84 00 00 00    	add    $0x84,%edx
80103ec6:	81 fa 54 3e 11 80    	cmp    $0x80113e54,%edx
...
80103eda:	75 e4                	jne    80103ec0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103edc:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103ee1:	eb 11                	jmp    80103ef4 <exit+0xf4>
80103ee3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103ee7:	90                   	nop
80103ee8:	05 84 00 00 00       	add    $0x84,%eax
80103eed:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
...
80103f17:	68 28 7b 10 80       	push   $0x80107b28
80103f1c:	e8 5f c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f21:	83 ec 0c             	sub    $0xc,%esp
80103f24:	68 1b 7b 10 80       	push   $0x80107b1b
...
80103f34:	53                   	push   %ebx
  pushcli();
80103f35:	e8 16 06 00 00       	call   80104550 <pushcli>
  c = mycpu();
80103f3a:	e8 d1 f9 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103f3f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f45:	e8 56 06 00 00       	call   801045a0 <popcli>
  acquire(&ptable.lock);
80103f4a:	83 ec 0c             	sub    $0xc,%esp
80103f4d:	68 20 1d 11 80       	push   $0x80111d20
80103f52:	e8 49 07 00 00       	call   801046a0 <acquire>
...
80103f6e:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
...
80103f7f:	74 5f                	je     80103fe0 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f81:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80103f87:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f8c:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
...
80103fa1:	0f 85 8f 00 00 00    	jne    80104036 <wait+0x106>
  pushcli();
80103fa7:	e8 a4 05 00 00       	call   80104550 <pushcli>
  c = mycpu();
80103fac:	e8 5f f9 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103fb1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fb7:	e8 e4 05 00 00       	call   801045a0 <popcli>
  if(p == 0)
...
80103ff9:	e8 b2 2f 00 00       	call   80106fb0 <freevm>
        p->pid = 0;
...
80104025:	e8 16 06 00 00       	call   80104640 <release>
        return pid;
...
8010406c:	e8 2f 06 00 00       	call   801046a0 <acquire>
  pushcli();
80104071:	e8 da 04 00 00       	call   80104550 <pushcli>
  c = mycpu();
80104076:	e8 95 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
8010407b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104081:	e8 1a 05 00 00       	call   801045a0 <popcli>
...
80104099:	e8 a2 05 00 00       	call   80104640 <release>
}
...
801040bc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801040bf:	e8 8c 04 00 00       	call   80104550 <pushcli>
  c = mycpu();
801040c4:	e8 47 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
801040c9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040cf:	e8 cc 04 00 00       	call   801045a0 <popcli>
  if(p == 0)
...
801040f8:	e8 43 05 00 00       	call   80104640 <release>
  p->chan = chan;
...
8010411a:	e8 21 05 00 00       	call   80104640 <release>
    acquire(lk);
...
80104159:	68 3a 7b 10 80       	push   $0x80107b3a
8010415e:	e8 1d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104163:	83 ec 0c             	sub    $0xc,%esp
80104166:	68 34 7b 10 80       	push   $0x80107b34
...
801041a7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041ae:	05 84 00 00 00       	add    $0x84,%eax
801041b3:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
801041b8:	75 e2                	jne    8010419c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
801041ba:	c7 45 08 20 1d 11 80 	movl   $0x80111d20,0x8(%ebp)
}
801041c1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801041c4:	c9                   	leave  
  release(&ptable.lock);
801041c5:	e9 76 04 00 00       	jmp    80104640 <release>
...
801041df:	e8 bc 04 00 00       	call   801046a0 <acquire>
801041e4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041e7:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
801041ec:	eb 0e                	jmp    801041fc <kill+0x2c>
801041ee:	66 90                	xchg   %ax,%ax
801041f0:	05 84 00 00 00       	add    $0x84,%eax
801041f5:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
...
80104218:	68 20 1d 11 80       	push   $0x80111d20
8010421d:	e8 1e 04 00 00       	call   80104640 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104238:	e8 03 04 00 00       	call   80104640 <release>
}
...
801042af:	ff 73 10             	push   0x10(%ebx)
801042b2:	53                   	push   %ebx
801042b3:	52                   	push   %edx
801042b4:	ff 73 a4             	push   -0x5c(%ebx)
801042b7:	68 4f 7b 10 80       	push   $0x80107b4f
801042bc:	e8 df c3 ff ff       	call   801006a0 <cprintf>
    if(p->state == SLEEPING){
801042c1:	83 c4 20             	add    $0x20,%esp
801042c4:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
801042c8:	75 9e                	jne    80104268 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801042ca:	83 ec 08             	sub    $0x8,%esp
801042cd:	8d 45 c0             	lea    -0x40(%ebp),%eax
801042d0:	8d 7d c0             	lea    -0x40(%ebp),%edi
801042d3:	50                   	push   %eax
801042d4:	8b 43 b0             	mov    -0x50(%ebx),%eax
801042d7:	8b 40 0c             	mov    0xc(%eax),%eax
801042da:	83 c0 08             	add    $0x8,%eax
801042dd:	50                   	push   %eax
801042de:	e8 0d 02 00 00       	call   801044f0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042f4:	0f 84 6e ff ff ff    	je     80104268 <procdump+0x18>
        cprintf(" %p", pc[i]);
...
80104301:	68 a1 75 10 80       	push   $0x801075a1
...
80104312:	e9 51 ff ff ff       	jmp    80104268 <procdump+0x18>
...
8010433b:	e8 60 03 00 00       	call   801046a0 <acquire>
	for(int i = 0; i < NPROC; i++){
80104340:	8b 55 08             	mov    0x8(%ebp),%edx
80104343:	b8 60 1d 11 80       	mov    $0x80111d60,%eax
80104348:	83 c4 10             	add    $0x10,%esp
8010434b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010434f:	90                   	nop
		struct proc *p = &ptable.proc[i];
    ps->inuse[i] = (p->state != UNUSED);
80104350:	31 c9                	xor    %ecx,%ecx
80104352:	83 38 00             	cmpl   $0x0,(%eax)
80104355:	0f 95 c1             	setne  %cl
	for(int i = 0; i < NPROC; i++){
80104358:	05 84 00 00 00       	add    $0x84,%eax
8010435d:	83 c2 04             	add    $0x4,%edx
    ps->inuse[i] = (p->state != UNUSED);
80104360:	89 4a fc             	mov    %ecx,-0x4(%edx)
		ps->tickets[i] = p->tickets;
80104363:	8b 48 ec             	mov    -0x14(%eax),%ecx
80104366:	89 8a fc 00 00 00    	mov    %ecx,0xfc(%edx)
		ps->pid[i] = p->pid;
8010436c:	8b 48 80             	mov    -0x80(%eax),%ecx
8010436f:	89 8a fc 01 00 00    	mov    %ecx,0x1fc(%edx)
		ps->ticks[i] = p->ticks;
80104375:	8b 48 f0             	mov    -0x10(%eax),%ecx
80104378:	89 8a fc 02 00 00    	mov    %ecx,0x2fc(%edx)
	for(int i = 0; i < NPROC; i++){
8010437e:	3d 60 3e 11 80       	cmp    $0x80113e60,%eax
80104383:	75 cb                	jne    80104350 <fillpinfo+0x20>
	}
	release(&ptable.lock);
80104385:	83 ec 0c             	sub    $0xc,%esp
80104388:	68 20 1d 11 80       	push   $0x80111d20
8010438d:	e8 ae 02 00 00       	call   80104640 <release>
	return 0;
}
80104392:	31 c0                	xor    %eax,%eax
80104394:	c9                   	leave  
80104395:	c3                   	ret    
...
801043aa:	68 c8 7b 10 80       	push   $0x80107bc8
...
80104405:	e8 a6 fc ff ff       	call   801040b0 <sleep>
  while (lk->locked) {
...
80104413:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104419:	e8 72 f5 ff ff       	call   80103990 <myproc>
...
80104464:	e8 07 fd ff ff       	call   80104170 <wakeup>
  release(&lk->lk);
...
801044bb:	e8 d0 f4 ff ff       	call   80103990 <myproc>
...
801045e5:	68 d3 7b 10 80       	push   $0x80107bd3
801045ea:	e8 91 bd ff ff       	call   80100380 <panic>
    panic("popcli");
801045ef:	83 ec 0c             	sub    $0xc,%esp
801045f2:	68 ea 7b 10 80       	push   $0x80107bea
...
8010465b:	68 f1 7b 10 80       	push   $0x80107bf1
...
801046dc:	e8 2f f2 ff ff       	call   80103910 <mycpu>
...
80104750:	68 f9 7b 10 80       	push   $0x80107bf9
...
801049d7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801049da:	e8 b1 ef ff ff       	call   80103990 <myproc>
...
80104a7e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a80:	e8 0b ef ff ff       	call   80103990 <myproc>
...
80104a8e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a91:	e8 fa ee ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ae4:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ae5:	e8 a6 ee ff ff       	call   80103990 <myproc>
...
80104af3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104af6:	e8 95 ee ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b0b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104b0e:	e8 7d ee ff ff       	call   80103990 <myproc>
  if(addr >= curproc->sz)
...
80104b64:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b67:	e8 24 ee ff ff       	call   80103990 <myproc>
...
80104b7c:	8b 14 85 20 7c 10 80 	mov    -0x7fef83e0(,%eax,4),%edx
...
80104ba8:	68 01 7c 10 80       	push   $0x80107c01
...
80104d04:	68 a4 7c 10 80       	push   $0x80107ca4
...
80104d1c:	68 a3 7c 10 80       	push   $0x80107ca3
...
80104d31:	68 97 7c 10 80       	push   $0x80107c97
...
80104d4f:	68 a6 7c 10 80       	push   $0x80107ca6
80104d54:	e8 27 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d59:	83 ec 0c             	sub    $0xc,%esp
80104d5c:	68 88 7c 10 80       	push   $0x80107c88
...
80104e08:	78 66                	js     80104e70 <sys_read+0x80>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104e0a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104e0e:	77 60                	ja     80104e70 <sys_read+0x80>
...
80104e1e:	74 50                	je     80104e70 <sys_read+0x80>
...
80104e33:	78 3b                	js     80104e70 <sys_read+0x80>
...
80104e48:	78 26                	js     80104e70 <sys_read+0x80>
...
80104e53:	56                   	push   %esi
	++readcount;
80104e54:	83 05 58 3e 11 80 01 	addl   $0x1,0x80113e58
  return fileread(f, p, n);
...
80104e8e:	e8 8d fb ff ff       	call   80104a20 <argint>
...
80104eb9:	e8 62 fb ff ff       	call   80104a20 <argint>
...
80104ece:	e8 9d fb ff ff       	call   80104a70 <argptr>
...
80104f0e:	e8 0d fb ff ff       	call   80104a20 <argint>
...
80104f6e:	e8 ad fa ff ff       	call   80104a20 <argint>
...
80104f98:	e8 d3 fa ff ff       	call   80104a70 <argptr>
...
80104fdf:	e8 fc fa ff ff       	call   80104ae0 <argstr>
...
80104ff8:	e8 e3 fa ff ff       	call   80104ae0 <argstr>
...
8010512f:	e8 ac f9 ff ff       	call   80104ae0 <argstr>
...
8010516d:	58                   	pop    %eax
8010516e:	5a                   	pop    %edx
8010516f:	68 a4 7c 10 80       	push   $0x80107ca4
...
80105188:	68 a3 7c 10 80       	push   $0x80107ca3
...
801051e2:	e8 79 f5 ff ff       	call   80104760 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010530f:	e8 cc f7 ff ff       	call   80104ae0 <argstr>
...
80105328:	e8 f3 f6 ff ff       	call   80104a20 <argint>
...
801053c7:	e8 04 f8 ff ff       	call   80104bd0 <create>
    if(ip == 0){
...
80105454:	e8 87 f6 ff ff       	call   80104ae0 <argstr>
...
801054b4:	e8 27 f6 ff ff       	call   80104ae0 <argstr>
...
801054c9:	e8 52 f5 ff ff       	call   80104a20 <argint>
  if((argstr(0, &path)) < 0 ||
...
801054de:	e8 3d f5 ff ff       	call   80104a20 <argint>
     argint(1, &major) < 0 ||
...
80105535:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105538:	e8 53 e4 ff ff       	call   80103990 <myproc>
...
8010554d:	e8 8e f5 ff ff       	call   80104ae0 <argstr>
...
801055f5:	e8 e6 f4 ff ff       	call   80104ae0 <argstr>
...
80105611:	e8 0a f4 ff ff       	call   80104a20 <argint>
...
80105630:	e8 2b f1 ff ff       	call   80104760 <memset>
...
8010565a:	e8 31 f3 ff ff       	call   80104990 <fetchint>
...
80105678:	e8 53 f3 ff ff       	call   801049d0 <fetchstr>
...
801056e1:	e8 8a f3 ff ff       	call   80104a70 <argptr>
...
80105707:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105709:	e8 82 e2 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105747:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010574a:	e8 41 e2 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105766:	75 f0                	jne    80105758 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105768:	e8 23 e2 ff ff       	call   80103990 <myproc>
...
801057b4:	83 ec 04             	sub    $0x4,%esp
	struct proc *curproc = myproc();
801057b7:	e8 d4 e1 ff ff       	call   80103990 <myproc>

	if(curproc->ofile[0] == 0){
801057bc:	8b 48 28             	mov    0x28(%eax),%ecx
801057bf:	85 c9                	test   %ecx,%ecx
801057c1:	74 25                	je     801057e8 <sys_getopenfilecount+0x38>
801057c3:	8d 50 2c             	lea    0x2c(%eax),%edx
801057c6:	8d 58 68             	lea    0x68(%eax),%ebx
		return 0;
	}
	int fd;
	int o = 0;
801057c9:	31 c0                	xor    %eax,%eax
801057cb:	eb 08                	jmp    801057d5 <sys_getopenfilecount+0x25>
801057cd:	8d 76 00             	lea    0x0(%esi),%esi
	for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] != 0){
801057d0:	8b 0a                	mov    (%edx),%ecx
801057d2:	83 c2 04             	add    $0x4,%edx
      ++o;
801057d5:	83 f9 01             	cmp    $0x1,%ecx
801057d8:	83 d8 ff             	sbb    $0xffffffff,%eax
	for(fd = 0; fd < NOFILE; fd++){
801057db:	39 da                	cmp    %ebx,%edx
801057dd:	75 f1                	jne    801057d0 <sys_getopenfilecount+0x20>
    }
  }
  return o;
}
...
{
  return fork();
801057f0:	e9 3b e3 ff ff       	jmp    80103b30 <fork>
...
80105803:	83 ec 08             	sub    $0x8,%esp
  exit();
80105806:	e8 f5 e5 ff ff       	call   80103e00 <exit>
...
{
  return wait();
80105810:	e9 1b e7 ff ff       	jmp    80103f30 <wait>
...
8010582c:	e8 ef f1 ff ff       	call   80104a20 <argint>
...
8010583e:	e8 8d e9 ff ff       	call   801041d0 <kill>
...
80105863:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105866:	e8 25 e1 ff ff       	call   80103990 <myproc>
...
8010587d:	e8 9e f1 ff ff       	call   80104a20 <argint>
80105882:	83 c4 10             	add    $0x10,%esp
80105885:	85 c0                	test   %eax,%eax
80105887:	78 27                	js     801058b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105889:	e8 02 e1 ff ff       	call   80103990 <myproc>
  if(growproc(n) < 0)
...
80105896:	e8 15 e2 ff ff       	call   80103ab0 <growproc>
...
801058cd:	e8 4e f1 ff ff       	call   80104a20 <argint>
...
801058e5:	e8 b6 ed ff ff       	call   801046a0 <acquire>
  ticks0 = ticks;
...
8010590d:	e8 9e e7 ff ff       	call   801040b0 <sleep>
  while(ticks - ticks0 < n){
...
8010591f:	73 2f                	jae    80105950 <sys_sleep+0x90>
    if(myproc()->killed){
80105921:	e8 6a e0 ff ff       	call   80103990 <myproc>
...
80105935:	e8 06 ed ff ff       	call   80104640 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105958:	e8 e3 ec ff ff       	call   80104640 <release>
  return 0;
...
801059ac:	e8 6f f0 ff ff       	call   80104a20 <argint>
801059b1:	83 c4 10             	add    $0x10,%esp
801059b4:	85 c0                	test   %eax,%eax
801059b6:	78 18                	js     801059d0 <sys_settickets+0x30>
801059b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059bb:	85 c0                	test   %eax,%eax
801059bd:	7e 11                	jle    801059d0 <sys_settickets+0x30>
		return -1;
	myproc()->tickets = t;
801059bf:	e8 cc df ff ff       	call   80103990 <myproc>
801059c4:	8b 55 f4             	mov    -0xc(%ebp),%edx
801059c7:	89 50 7c             	mov    %edx,0x7c(%eax)
	return 0;
801059ca:	31 c0                	xor    %eax,%eax
}
801059cc:	c9                   	leave  
801059cd:	c3                   	ret    
...
80105a20:	06                   	push   %es
  pushl %fs
80105a21:	0f a0                	push   %fs
  pushl %gs
80105a23:	0f a8                	push   %gs
  pushal
80105a25:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105a26:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105a2a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105a2c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105a2e:	54                   	push   %esp
  call trap
80105a2f:	e8 cc 00 00 00       	call   80105b00 <trap>
  addl $4, %esp
80105a34:	83 c4 04             	add    $0x4,%esp
...
80105a37:	61                   	popa   
  popl %gs
80105a38:	0f a9                	pop    %gs
  popl %fs
80105a3a:	0f a1                	pop    %fs
  popl %es
80105a3c:	07                   	pop    %es
  popl %ds
80105a3d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105a3e:	83 c4 08             	add    $0x8,%esp
  iret
80105a41:	cf                   	iret   
80105a42:	66 90                	xchg   %ax,%ax
...
80105a67:	c7 04 c5 c2 3e 11 80 	movl   $0x8e000008,-0x7feec13e(,%eax,8)
80105a6e:	08 00 00 8e 
80105a72:	66 89 14 c5 c0 3e 11 	mov    %dx,-0x7feec140(,%eax,8)
80105a79:	80 
80105a7a:	c1 ea 10             	shr    $0x10,%edx
80105a7d:	66 89 14 c5 c6 3e 11 	mov    %dx,-0x7feec13a(,%eax,8)
80105a84:	80 
  for(i = 0; i < 256; i++)
...
80105a97:	c7 05 c2 40 11 80 08 	movl   $0xef000008,0x801140c2
80105a9e:	00 00 ef 
  initlock(&tickslock, "time");
80105aa1:	68 e9 7c 10 80       	push   $0x80107ce9
80105aa6:	68 80 3e 11 80       	push   $0x80113e80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105aab:	66 a3 c0 40 11 80    	mov    %ax,0x801140c0
80105ab1:	c1 e8 10             	shr    $0x10,%eax
80105ab4:	66 a3 c6 40 11 80    	mov    %ax,0x801140c6
  initlock(&tickslock, "time");
80105aba:	e8 11 ea ff ff       	call   801044d0 <initlock>
}
...
80105adb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105adf:	b8 c0 3e 11 80       	mov    $0x80113ec0,%eax
...
80105b24:	ff 24 85 90 7d 10 80 	jmp    *-0x7fef8270(,%eax,4)
...
80105b3a:	e8 51 de ff ff       	call   80103990 <myproc>
80105b3f:	85 c0                	test   %eax,%eax
80105b41:	74 1d                	je     80105b60 <trap+0x60>
80105b43:	e8 48 de ff ff       	call   80103990 <myproc>
...
80105b69:	e8 22 de ff ff       	call   80103990 <myproc>
...
80105bb0:	e8 db dd ff ff       	call   80103990 <myproc>
...
80105be9:	e8 a2 dd ff ff       	call   80103990 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105c05:	68 4c 7d 10 80       	push   $0x80107d4c
80105c0a:	e8 91 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105c0f:	83 c4 20             	add    $0x20,%esp
80105c12:	e8 79 dd ff ff       	call   80103990 <myproc>
80105c17:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c1e:	e8 6d dd ff ff       	call   80103990 <myproc>
...
80105c34:	0f 85 3e ff ff ff    	jne    80105b78 <trap+0x78>
    yield();
80105c3a:	e8 21 e4 ff ff       	call   80104060 <yield>
...
80105c4f:	e8 1c dd ff ff       	call   80103970 <cpuid>
80105c54:	57                   	push   %edi
80105c55:	56                   	push   %esi
80105c56:	50                   	push   %eax
80105c57:	68 f4 7c 10 80       	push   $0x80107cf4
...
80105c7f:	90                   	nop
    if(myproc()->killed)
80105c80:	e8 0b dd ff ff       	call   80103990 <myproc>
...
80105c95:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c98:	e8 c3 ee ff ff       	call   80104b60 <syscall>
    if(myproc()->killed)
80105c9d:	e8 ee dc ff ff       	call   80103990 <myproc>
...
80105cb3:	5d                   	pop    %ebp
      exit();
80105cb4:	e9 47 e1 ff ff       	jmp    80103e00 <exit>
...
80105d15:	e8 86 e9 ff ff       	call   801046a0 <acquire>
      wakeup(&ticks);
80105d1a:	c7 04 24 60 3e 11 80 	movl   $0x80113e60,(%esp)
      ticks++;
80105d21:	83 05 60 3e 11 80 01 	addl   $0x1,0x80113e60
      wakeup(&ticks);
80105d28:	e8 43 e4 ff ff       	call   80104170 <wakeup>
      release(&tickslock);
80105d2d:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
80105d34:	e8 07 e9 ff ff       	call   80104640 <release>
...
80105e17:	74 78                	je     80105e91 <uartinit+0xd1>
  uart = 1;
80105e19:	c7 05 c0 46 11 80 01 	movl   $0x1,0x801146c0
80105e20:	00 00 00 
...
80105e2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e2f:	bf 10 7e 10 80       	mov    $0x80107e10,%edi
...
80105f17:	6a 00                	push   $0x0
  jmp alltraps
80105f19:	e9 01 fb ff ff       	jmp    80105a1f <alltraps>
...
80105f20:	6a 01                	push   $0x1
  jmp alltraps
80105f22:	e9 f8 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f29:	6a 02                	push   $0x2
  jmp alltraps
80105f2b:	e9 ef fa ff ff       	jmp    80105a1f <alltraps>
...
80105f32:	6a 03                	push   $0x3
  jmp alltraps
80105f34:	e9 e6 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f3b:	6a 04                	push   $0x4
  jmp alltraps
80105f3d:	e9 dd fa ff ff       	jmp    80105a1f <alltraps>
...
80105f44:	6a 05                	push   $0x5
  jmp alltraps
80105f46:	e9 d4 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f4d:	6a 06                	push   $0x6
  jmp alltraps
80105f4f:	e9 cb fa ff ff       	jmp    80105a1f <alltraps>
...
80105f56:	6a 07                	push   $0x7
  jmp alltraps
80105f58:	e9 c2 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f5d:	6a 08                	push   $0x8
  jmp alltraps
80105f5f:	e9 bb fa ff ff       	jmp    80105a1f <alltraps>
...
80105f66:	6a 09                	push   $0x9
  jmp alltraps
80105f68:	e9 b2 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f6d:	6a 0a                	push   $0xa
  jmp alltraps
80105f6f:	e9 ab fa ff ff       	jmp    80105a1f <alltraps>
...
80105f74:	6a 0b                	push   $0xb
  jmp alltraps
80105f76:	e9 a4 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f7b:	6a 0c                	push   $0xc
  jmp alltraps
80105f7d:	e9 9d fa ff ff       	jmp    80105a1f <alltraps>
...
80105f82:	6a 0d                	push   $0xd
  jmp alltraps
80105f84:	e9 96 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f89:	6a 0e                	push   $0xe
  jmp alltraps
80105f8b:	e9 8f fa ff ff       	jmp    80105a1f <alltraps>
...
80105f92:	6a 0f                	push   $0xf
  jmp alltraps
80105f94:	e9 86 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f9b:	6a 10                	push   $0x10
  jmp alltraps
80105f9d:	e9 7d fa ff ff       	jmp    80105a1f <alltraps>
...
80105fa2:	6a 11                	push   $0x11
  jmp alltraps
80105fa4:	e9 76 fa ff ff       	jmp    80105a1f <alltraps>
...
80105fab:	6a 12                	push   $0x12
  jmp alltraps
80105fad:	e9 6d fa ff ff       	jmp    80105a1f <alltraps>
...
80105fb4:	6a 13                	push   $0x13
  jmp alltraps
80105fb6:	e9 64 fa ff ff       	jmp    80105a1f <alltraps>
...
80105fbd:	6a 14                	push   $0x14
  jmp alltraps
80105fbf:	e9 5b fa ff ff       	jmp    80105a1f <alltraps>
...
80105fc6:	6a 15                	push   $0x15
  jmp alltraps
80105fc8:	e9 52 fa ff ff       	jmp    80105a1f <alltraps>
...
80105fcf:	6a 16                	push   $0x16
  jmp alltraps
80105fd1:	e9 49 fa ff ff       	jmp    80105a1f <alltraps>
...
80105fd8:	6a 17                	push   $0x17
  jmp alltraps
80105fda:	e9 40 fa ff ff       	jmp    80105a1f <alltraps>
...
80105fe1:	6a 18                	push   $0x18
  jmp alltraps
80105fe3:	e9 37 fa ff ff       	jmp    80105a1f <alltraps>
...
80105fea:	6a 19                	push   $0x19
  jmp alltraps
80105fec:	e9 2e fa ff ff       	jmp    80105a1f <alltraps>
...
80105ff3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ff5:	e9 25 fa ff ff       	jmp    80105a1f <alltraps>
...
80105ffc:	6a 1b                	push   $0x1b
  jmp alltraps
80105ffe:	e9 1c fa ff ff       	jmp    80105a1f <alltraps>
...
80106005:	6a 1c                	push   $0x1c
  jmp alltraps
80106007:	e9 13 fa ff ff       	jmp    80105a1f <alltraps>
...
8010600e:	6a 1d                	push   $0x1d
  jmp alltraps
80106010:	e9 0a fa ff ff       	jmp    80105a1f <alltraps>
...
80106017:	6a 1e                	push   $0x1e
  jmp alltraps
80106019:	e9 01 fa ff ff       	jmp    80105a1f <alltraps>
...
80106020:	6a 1f                	push   $0x1f
  jmp alltraps
80106022:	e9 f8 f9 ff ff       	jmp    80105a1f <alltraps>
...
80106029:	6a 20                	push   $0x20
  jmp alltraps
8010602b:	e9 ef f9 ff ff       	jmp    80105a1f <alltraps>
...
80106032:	6a 21                	push   $0x21
  jmp alltraps
80106034:	e9 e6 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010603b:	6a 22                	push   $0x22
  jmp alltraps
8010603d:	e9 dd f9 ff ff       	jmp    80105a1f <alltraps>
...
80106044:	6a 23                	push   $0x23
  jmp alltraps
80106046:	e9 d4 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010604d:	6a 24                	push   $0x24
  jmp alltraps
8010604f:	e9 cb f9 ff ff       	jmp    80105a1f <alltraps>
...
80106056:	6a 25                	push   $0x25
  jmp alltraps
80106058:	e9 c2 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010605f:	6a 26                	push   $0x26
  jmp alltraps
80106061:	e9 b9 f9 ff ff       	jmp    80105a1f <alltraps>
...
80106068:	6a 27                	push   $0x27
  jmp alltraps
8010606a:	e9 b0 f9 ff ff       	jmp    80105a1f <alltraps>
...
80106071:	6a 28                	push   $0x28
  jmp alltraps
80106073:	e9 a7 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010607a:	6a 29                	push   $0x29
  jmp alltraps
8010607c:	e9 9e f9 ff ff       	jmp    80105a1f <alltraps>
...
80106083:	6a 2a                	push   $0x2a
  jmp alltraps
80106085:	e9 95 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010608c:	6a 2b                	push   $0x2b
  jmp alltraps
8010608e:	e9 8c f9 ff ff       	jmp    80105a1f <alltraps>
...
80106095:	6a 2c                	push   $0x2c
  jmp alltraps
80106097:	e9 83 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010609e:	6a 2d                	push   $0x2d
  jmp alltraps
801060a0:	e9 7a f9 ff ff       	jmp    80105a1f <alltraps>
...
801060a7:	6a 2e                	push   $0x2e
  jmp alltraps
801060a9:	e9 71 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060b0:	6a 2f                	push   $0x2f
  jmp alltraps
801060b2:	e9 68 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060b9:	6a 30                	push   $0x30
  jmp alltraps
801060bb:	e9 5f f9 ff ff       	jmp    80105a1f <alltraps>
...
801060c2:	6a 31                	push   $0x31
  jmp alltraps
801060c4:	e9 56 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060cb:	6a 32                	push   $0x32
  jmp alltraps
801060cd:	e9 4d f9 ff ff       	jmp    80105a1f <alltraps>
...
801060d4:	6a 33                	push   $0x33
  jmp alltraps
801060d6:	e9 44 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060dd:	6a 34                	push   $0x34
  jmp alltraps
801060df:	e9 3b f9 ff ff       	jmp    80105a1f <alltraps>
...
801060e6:	6a 35                	push   $0x35
  jmp alltraps
801060e8:	e9 32 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060ef:	6a 36                	push   $0x36
  jmp alltraps
801060f1:	e9 29 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060f8:	6a 37                	push   $0x37
  jmp alltraps
801060fa:	e9 20 f9 ff ff       	jmp    80105a1f <alltraps>
...
80106101:	6a 38                	push   $0x38
  jmp alltraps
80106103:	e9 17 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010610a:	6a 39                	push   $0x39
  jmp alltraps
8010610c:	e9 0e f9 ff ff       	jmp    80105a1f <alltraps>
...
80106113:	6a 3a                	push   $0x3a
  jmp alltraps
80106115:	e9 05 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010611c:	6a 3b                	push   $0x3b
  jmp alltraps
8010611e:	e9 fc f8 ff ff       	jmp    80105a1f <alltraps>
...
80106125:	6a 3c                	push   $0x3c
  jmp alltraps
80106127:	e9 f3 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010612e:	6a 3d                	push   $0x3d
  jmp alltraps
80106130:	e9 ea f8 ff ff       	jmp    80105a1f <alltraps>
...
80106137:	6a 3e                	push   $0x3e
  jmp alltraps
80106139:	e9 e1 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106140:	6a 3f                	push   $0x3f
  jmp alltraps
80106142:	e9 d8 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106149:	6a 40                	push   $0x40
  jmp alltraps
8010614b:	e9 cf f8 ff ff       	jmp    80105a1f <alltraps>
...
80106152:	6a 41                	push   $0x41
  jmp alltraps
80106154:	e9 c6 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010615b:	6a 42                	push   $0x42
  jmp alltraps
8010615d:	e9 bd f8 ff ff       	jmp    80105a1f <alltraps>
...
80106164:	6a 43                	push   $0x43
  jmp alltraps
80106166:	e9 b4 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010616d:	6a 44                	push   $0x44
  jmp alltraps
8010616f:	e9 ab f8 ff ff       	jmp    80105a1f <alltraps>
...
80106176:	6a 45                	push   $0x45
  jmp alltraps
80106178:	e9 a2 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010617f:	6a 46                	push   $0x46
  jmp alltraps
80106181:	e9 99 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106188:	6a 47                	push   $0x47
  jmp alltraps
8010618a:	e9 90 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106191:	6a 48                	push   $0x48
  jmp alltraps
80106193:	e9 87 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010619a:	6a 49                	push   $0x49
  jmp alltraps
8010619c:	e9 7e f8 ff ff       	jmp    80105a1f <alltraps>
...
801061a3:	6a 4a                	push   $0x4a
  jmp alltraps
801061a5:	e9 75 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061ac:	6a 4b                	push   $0x4b
  jmp alltraps
801061ae:	e9 6c f8 ff ff       	jmp    80105a1f <alltraps>
...
801061b5:	6a 4c                	push   $0x4c
  jmp alltraps
801061b7:	e9 63 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061be:	6a 4d                	push   $0x4d
  jmp alltraps
801061c0:	e9 5a f8 ff ff       	jmp    80105a1f <alltraps>
...
801061c7:	6a 4e                	push   $0x4e
  jmp alltraps
801061c9:	e9 51 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061d0:	6a 4f                	push   $0x4f
  jmp alltraps
801061d2:	e9 48 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061d9:	6a 50                	push   $0x50
  jmp alltraps
801061db:	e9 3f f8 ff ff       	jmp    80105a1f <alltraps>
...
801061e2:	6a 51                	push   $0x51
  jmp alltraps
801061e4:	e9 36 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061eb:	6a 52                	push   $0x52
  jmp alltraps
801061ed:	e9 2d f8 ff ff       	jmp    80105a1f <alltraps>
...
801061f4:	6a 53                	push   $0x53
  jmp alltraps
801061f6:	e9 24 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061fd:	6a 54                	push   $0x54
  jmp alltraps
801061ff:	e9 1b f8 ff ff       	jmp    80105a1f <alltraps>
...
80106206:	6a 55                	push   $0x55
  jmp alltraps
80106208:	e9 12 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010620f:	6a 56                	push   $0x56
  jmp alltraps
80106211:	e9 09 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106218:	6a 57                	push   $0x57
  jmp alltraps
8010621a:	e9 00 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106221:	6a 58                	push   $0x58
  jmp alltraps
80106223:	e9 f7 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010622a:	6a 59                	push   $0x59
  jmp alltraps
8010622c:	e9 ee f7 ff ff       	jmp    80105a1f <alltraps>
...
80106233:	6a 5a                	push   $0x5a
  jmp alltraps
80106235:	e9 e5 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010623c:	6a 5b                	push   $0x5b
  jmp alltraps
8010623e:	e9 dc f7 ff ff       	jmp    80105a1f <alltraps>
...
80106245:	6a 5c                	push   $0x5c
  jmp alltraps
80106247:	e9 d3 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010624e:	6a 5d                	push   $0x5d
  jmp alltraps
80106250:	e9 ca f7 ff ff       	jmp    80105a1f <alltraps>
...
80106257:	6a 5e                	push   $0x5e
  jmp alltraps
80106259:	e9 c1 f7 ff ff       	jmp    80105a1f <alltraps>
...
80106260:	6a 5f                	push   $0x5f
  jmp alltraps
80106262:	e9 b8 f7 ff ff       	jmp    80105a1f <alltraps>
...
80106269:	6a 60                	push   $0x60
  jmp alltraps
8010626b:	e9 af f7 ff ff       	jmp    80105a1f <alltraps>
...
80106272:	6a 61                	push   $0x61
  jmp alltraps
80106274:	e9 a6 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010627b:	6a 62                	push   $0x62
  jmp alltraps
8010627d:	e9 9d f7 ff ff       	jmp    80105a1f <alltraps>
...
80106284:	6a 63                	push   $0x63
  jmp alltraps
80106286:	e9 94 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010628d:	6a 64                	push   $0x64
  jmp alltraps
8010628f:	e9 8b f7 ff ff       	jmp    80105a1f <alltraps>
...
80106296:	6a 65                	push   $0x65
  jmp alltraps
80106298:	e9 82 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010629f:	6a 66                	push   $0x66
  jmp alltraps
801062a1:	e9 79 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062a8:	6a 67                	push   $0x67
  jmp alltraps
801062aa:	e9 70 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062b1:	6a 68                	push   $0x68
  jmp alltraps
801062b3:	e9 67 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062ba:	6a 69                	push   $0x69
  jmp alltraps
801062bc:	e9 5e f7 ff ff       	jmp    80105a1f <alltraps>
...
801062c3:	6a 6a                	push   $0x6a
  jmp alltraps
801062c5:	e9 55 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062cc:	6a 6b                	push   $0x6b
  jmp alltraps
801062ce:	e9 4c f7 ff ff       	jmp    80105a1f <alltraps>
...
801062d5:	6a 6c                	push   $0x6c
  jmp alltraps
801062d7:	e9 43 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062de:	6a 6d                	push   $0x6d
  jmp alltraps
801062e0:	e9 3a f7 ff ff       	jmp    80105a1f <alltraps>
...
801062e7:	6a 6e                	push   $0x6e
  jmp alltraps
801062e9:	e9 31 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062f0:	6a 6f                	push   $0x6f
  jmp alltraps
801062f2:	e9 28 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062f9:	6a 70                	push   $0x70
  jmp alltraps
801062fb:	e9 1f f7 ff ff       	jmp    80105a1f <alltraps>
...
80106302:	6a 71                	push   $0x71
  jmp alltraps
80106304:	e9 16 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010630b:	6a 72                	push   $0x72
  jmp alltraps
8010630d:	e9 0d f7 ff ff       	jmp    80105a1f <alltraps>
...
80106314:	6a 73                	push   $0x73
  jmp alltraps
80106316:	e9 04 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010631d:	6a 74                	push   $0x74
  jmp alltraps
8010631f:	e9 fb f6 ff ff       	jmp    80105a1f <alltraps>
...
80106326:	6a 75                	push   $0x75
  jmp alltraps
80106328:	e9 f2 f6 ff ff       	jmp    80105a1f <alltraps>
...
8010632f:	6a 76                	push   $0x76
  jmp alltraps
80106331:	e9 e9 f6 ff ff       	jmp    80105a1f <alltraps>
...
80106338:	6a 77                	push   $0x77
  jmp alltraps
8010633a:	e9 e0 f6 ff ff       	jmp    80105a1f <alltraps>
...
80106341:	6a 78                	push   $0x78
  jmp alltraps
80106343:	e9 d7 f6 ff ff       	jmp    80105a1f <alltraps>
...
8010634a:	6a 79                	push   $0x79
  jmp alltraps
8010634c:	e9 ce f6 ff ff       	jmp    80105a1f <alltraps>
...
80106353:	6a 7a                	push   $0x7a
  jmp alltraps
80106355:	e9 c5 f6 ff ff       	jmp    80105a1f <alltraps>
...
8010635c:	6a 7b                	push   $0x7b
  jmp alltraps
8010635e:	e9 bc f6 ff ff       	jmp    80105a1f <alltraps>
...
80106365:	6a 7c                	push   $0x7c
  jmp alltraps
80106367:	e9 b3 f6 ff ff       	jmp    80105a1f <alltraps>
...
8010636e:	6a 7d                	push   $0x7d
  jmp alltraps
80106370:	e9 aa f6 ff ff       	jmp    80105a1f <alltraps>
...
80106377:	6a 7e                	push   $0x7e
  jmp alltraps
80106379:	e9 a1 f6 ff ff       	jmp    80105a1f <alltraps>
...
80106380:	6a 7f                	push   $0x7f
  jmp alltraps
80106382:	e9 98 f6 ff ff       	jmp    80105a1f <alltraps>
...
80106389:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010638e:	e9 8c f6 ff ff       	jmp    80105a1f <alltraps>
...
80106395:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010639a:	e9 80 f6 ff ff       	jmp    80105a1f <alltraps>
...
801063a1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063a6:	e9 74 f6 ff ff       	jmp    80105a1f <alltraps>
...
801063ad:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063b2:	e9 68 f6 ff ff       	jmp    80105a1f <alltraps>
...
801063b9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063be:	e9 5c f6 ff ff       	jmp    80105a1f <alltraps>
...
801063c5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063ca:	e9 50 f6 ff ff       	jmp    80105a1f <alltraps>
...
801063d1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801063d6:	e9 44 f6 ff ff       	jmp    80105a1f <alltraps>
...
801063dd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801063e2:	e9 38 f6 ff ff       	jmp    80105a1f <alltraps>
...
801063e9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801063ee:	e9 2c f6 ff ff       	jmp    80105a1f <alltraps>
...
801063f5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801063fa:	e9 20 f6 ff ff       	jmp    80105a1f <alltraps>
...
80106401:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106406:	e9 14 f6 ff ff       	jmp    80105a1f <alltraps>
...
8010640d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106412:	e9 08 f6 ff ff       	jmp    80105a1f <alltraps>
...
80106419:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010641e:	e9 fc f5 ff ff       	jmp    80105a1f <alltraps>
...
80106425:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010642a:	e9 f0 f5 ff ff       	jmp    80105a1f <alltraps>
...
80106431:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106436:	e9 e4 f5 ff ff       	jmp    80105a1f <alltraps>
...
8010643d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106442:	e9 d8 f5 ff ff       	jmp    80105a1f <alltraps>
...
80106449:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010644e:	e9 cc f5 ff ff       	jmp    80105a1f <alltraps>
...
80106455:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010645a:	e9 c0 f5 ff ff       	jmp    80105a1f <alltraps>
...
80106461:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106466:	e9 b4 f5 ff ff       	jmp    80105a1f <alltraps>
...
8010646d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106472:	e9 a8 f5 ff ff       	jmp    80105a1f <alltraps>
...
80106479:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010647e:	e9 9c f5 ff ff       	jmp    80105a1f <alltraps>
...
80106485:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010648a:	e9 90 f5 ff ff       	jmp    80105a1f <alltraps>
...
80106491:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106496:	e9 84 f5 ff ff       	jmp    80105a1f <alltraps>
...
8010649d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064a2:	e9 78 f5 ff ff       	jmp    80105a1f <alltraps>
...
801064a9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064ae:	e9 6c f5 ff ff       	jmp    80105a1f <alltraps>
...
801064b5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064ba:	e9 60 f5 ff ff       	jmp    80105a1f <alltraps>
...
801064c1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064c6:	e9 54 f5 ff ff       	jmp    80105a1f <alltraps>
...
801064cd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801064d2:	e9 48 f5 ff ff       	jmp    80105a1f <alltraps>
...
801064d9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801064de:	e9 3c f5 ff ff       	jmp    80105a1f <alltraps>
...
801064e5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801064ea:	e9 30 f5 ff ff       	jmp    80105a1f <alltraps>
...
801064f1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801064f6:	e9 24 f5 ff ff       	jmp    80105a1f <alltraps>
...
801064fd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106502:	e9 18 f5 ff ff       	jmp    80105a1f <alltraps>
...
80106509:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010650e:	e9 0c f5 ff ff       	jmp    80105a1f <alltraps>
...
80106515:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010651a:	e9 00 f5 ff ff       	jmp    80105a1f <alltraps>
...
80106521:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106526:	e9 f4 f4 ff ff       	jmp    80105a1f <alltraps>
...
8010652d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106532:	e9 e8 f4 ff ff       	jmp    80105a1f <alltraps>
...
80106539:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010653e:	e9 dc f4 ff ff       	jmp    80105a1f <alltraps>
...
80106545:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010654a:	e9 d0 f4 ff ff       	jmp    80105a1f <alltraps>
...
80106551:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106556:	e9 c4 f4 ff ff       	jmp    80105a1f <alltraps>
...
8010655d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106562:	e9 b8 f4 ff ff       	jmp    80105a1f <alltraps>
...
80106569:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010656e:	e9 ac f4 ff ff       	jmp    80105a1f <alltraps>
...
80106575:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010657a:	e9 a0 f4 ff ff       	jmp    80105a1f <alltraps>
...
80106581:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106586:	e9 94 f4 ff ff       	jmp    80105a1f <alltraps>
...
8010658d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106592:	e9 88 f4 ff ff       	jmp    80105a1f <alltraps>
...
80106599:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010659e:	e9 7c f4 ff ff       	jmp    80105a1f <alltraps>
...
801065a5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065aa:	e9 70 f4 ff ff       	jmp    80105a1f <alltraps>
...
801065b1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065b6:	e9 64 f4 ff ff       	jmp    80105a1f <alltraps>
...
801065bd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065c2:	e9 58 f4 ff ff       	jmp    80105a1f <alltraps>
...
801065c9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065ce:	e9 4c f4 ff ff       	jmp    80105a1f <alltraps>
...
801065d5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801065da:	e9 40 f4 ff ff       	jmp    80105a1f <alltraps>
...
801065e1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801065e6:	e9 34 f4 ff ff       	jmp    80105a1f <alltraps>
...
801065ed:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801065f2:	e9 28 f4 ff ff       	jmp    80105a1f <alltraps>
...
801065f9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801065fe:	e9 1c f4 ff ff       	jmp    80105a1f <alltraps>
...
80106605:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010660a:	e9 10 f4 ff ff       	jmp    80105a1f <alltraps>
...
80106611:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106616:	e9 04 f4 ff ff       	jmp    80105a1f <alltraps>
...
8010661d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106622:	e9 f8 f3 ff ff       	jmp    80105a1f <alltraps>
...
80106629:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010662e:	e9 ec f3 ff ff       	jmp    80105a1f <alltraps>
...
80106635:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010663a:	e9 e0 f3 ff ff       	jmp    80105a1f <alltraps>
...
80106641:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106646:	e9 d4 f3 ff ff       	jmp    80105a1f <alltraps>
...
8010664d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106652:	e9 c8 f3 ff ff       	jmp    80105a1f <alltraps>
...
80106659:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010665e:	e9 bc f3 ff ff       	jmp    80105a1f <alltraps>
...
80106665:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010666a:	e9 b0 f3 ff ff       	jmp    80105a1f <alltraps>
...
80106671:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106676:	e9 a4 f3 ff ff       	jmp    80105a1f <alltraps>
...
8010667d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106682:	e9 98 f3 ff ff       	jmp    80105a1f <alltraps>
...
80106689:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010668e:	e9 8c f3 ff ff       	jmp    80105a1f <alltraps>
...
80106695:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010669a:	e9 80 f3 ff ff       	jmp    80105a1f <alltraps>
...
801066a1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066a6:	e9 74 f3 ff ff       	jmp    80105a1f <alltraps>
...
801066ad:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066b2:	e9 68 f3 ff ff       	jmp    80105a1f <alltraps>
...
801066b9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066be:	e9 5c f3 ff ff       	jmp    80105a1f <alltraps>
...
801066c5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066ca:	e9 50 f3 ff ff       	jmp    80105a1f <alltraps>
...
801066d1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801066d6:	e9 44 f3 ff ff       	jmp    80105a1f <alltraps>
...
801066dd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801066e2:	e9 38 f3 ff ff       	jmp    80105a1f <alltraps>
...
801066e9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801066ee:	e9 2c f3 ff ff       	jmp    80105a1f <alltraps>
...
801066f5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801066fa:	e9 20 f3 ff ff       	jmp    80105a1f <alltraps>
...
80106701:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106706:	e9 14 f3 ff ff       	jmp    80105a1f <alltraps>
...
8010670d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106712:	e9 08 f3 ff ff       	jmp    80105a1f <alltraps>
...
80106719:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010671e:	e9 fc f2 ff ff       	jmp    80105a1f <alltraps>
...
80106725:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010672a:	e9 f0 f2 ff ff       	jmp    80105a1f <alltraps>
...
80106731:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106736:	e9 e4 f2 ff ff       	jmp    80105a1f <alltraps>
...
8010673d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106742:	e9 d8 f2 ff ff       	jmp    80105a1f <alltraps>
...
80106749:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010674e:	e9 cc f2 ff ff       	jmp    80105a1f <alltraps>
...
80106755:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010675a:	e9 c0 f2 ff ff       	jmp    80105a1f <alltraps>
...
80106761:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106766:	e9 b4 f2 ff ff       	jmp    80105a1f <alltraps>
...
8010676d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106772:	e9 a8 f2 ff ff       	jmp    80105a1f <alltraps>
...
80106779:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010677e:	e9 9c f2 ff ff       	jmp    80105a1f <alltraps>
...
80106785:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010678a:	e9 90 f2 ff ff       	jmp    80105a1f <alltraps>
...
80106791:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106796:	e9 84 f2 ff ff       	jmp    80105a1f <alltraps>
...
8010679d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067a2:	e9 78 f2 ff ff       	jmp    80105a1f <alltraps>
...
801067a9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067ae:	e9 6c f2 ff ff       	jmp    80105a1f <alltraps>
...
801067b5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067ba:	e9 60 f2 ff ff       	jmp    80105a1f <alltraps>
...
801067c1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067c6:	e9 54 f2 ff ff       	jmp    80105a1f <alltraps>
...
801067cd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801067d2:	e9 48 f2 ff ff       	jmp    80105a1f <alltraps>
...
801067d9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801067de:	e9 3c f2 ff ff       	jmp    80105a1f <alltraps>
...
801067e5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801067ea:	e9 30 f2 ff ff       	jmp    80105a1f <alltraps>
...
801067f1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801067f6:	e9 24 f2 ff ff       	jmp    80105a1f <alltraps>
...
801067fd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106802:	e9 18 f2 ff ff       	jmp    80105a1f <alltraps>
...
80106809:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010680e:	e9 0c f2 ff ff       	jmp    80105a1f <alltraps>
...
80106815:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010681a:	e9 00 f2 ff ff       	jmp    80105a1f <alltraps>
...
80106821:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106826:	e9 f4 f1 ff ff       	jmp    80105a1f <alltraps>
...
8010682d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106832:	e9 e8 f1 ff ff       	jmp    80105a1f <alltraps>
...
80106839:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010683e:	e9 dc f1 ff ff       	jmp    80105a1f <alltraps>
...
80106845:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010684a:	e9 d0 f1 ff ff       	jmp    80105a1f <alltraps>
...
80106851:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106856:	e9 c4 f1 ff ff       	jmp    80105a1f <alltraps>
...
8010685d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106862:	e9 b8 f1 ff ff       	jmp    80105a1f <alltraps>
...
80106869:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010686e:	e9 ac f1 ff ff       	jmp    80105a1f <alltraps>
...
80106875:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010687a:	e9 a0 f1 ff ff       	jmp    80105a1f <alltraps>
...
80106881:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106886:	e9 94 f1 ff ff       	jmp    80105a1f <alltraps>
...
8010688d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106892:	e9 88 f1 ff ff       	jmp    80105a1f <alltraps>
...
80106899:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010689e:	e9 7c f1 ff ff       	jmp    80105a1f <alltraps>
...
801068a5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068aa:	e9 70 f1 ff ff       	jmp    80105a1f <alltraps>
...
801068b1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068b6:	e9 64 f1 ff ff       	jmp    80105a1f <alltraps>
...
801068bd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068c2:	e9 58 f1 ff ff       	jmp    80105a1f <alltraps>
...
801068c9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068ce:	e9 4c f1 ff ff       	jmp    80105a1f <alltraps>
...
801068d5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801068da:	e9 40 f1 ff ff       	jmp    80105a1f <alltraps>
...
801068e1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801068e6:	e9 34 f1 ff ff       	jmp    80105a1f <alltraps>
...
801068ed:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801068f2:	e9 28 f1 ff ff       	jmp    80105a1f <alltraps>
...
801068f9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801068fe:	e9 1c f1 ff ff       	jmp    80105a1f <alltraps>
...
80106905:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010690a:	e9 10 f1 ff ff       	jmp    80105a1f <alltraps>
...
80106911:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106916:	e9 04 f1 ff ff       	jmp    80105a1f <alltraps>
...
8010691d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106922:	e9 f8 f0 ff ff       	jmp    80105a1f <alltraps>
...
80106929:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010692e:	e9 ec f0 ff ff       	jmp    80105a1f <alltraps>
...
80106935:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010693a:	e9 e0 f0 ff ff       	jmp    80105a1f <alltraps>
...
80106941:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106946:	e9 d4 f0 ff ff       	jmp    80105a1f <alltraps>
...
8010694d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106952:	e9 c8 f0 ff ff       	jmp    80105a1f <alltraps>
...
80106959:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010695e:	e9 bc f0 ff ff       	jmp    80105a1f <alltraps>
...
80106965:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010696a:	e9 b0 f0 ff ff       	jmp    80105a1f <alltraps>
...
80106971:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106976:	e9 a4 f0 ff ff       	jmp    80105a1f <alltraps>
...
8010697d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106982:	e9 98 f0 ff ff       	jmp    80105a1f <alltraps>
...
80106a2f:	68 c6 77 10 80       	push   $0x801077c6
...
80106ad5:	e8 86 dc ff ff       	call   80104760 <memset>
...
80106b1d:	68 18 7e 10 80       	push   $0x80107e18
...
80106b33:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b36:	e8 35 ce ff ff       	call   80103970 <cpuid>
  pd[0] = size-1;
...
80106bc0:	a1 c4 46 11 80       	mov    0x801146c4,%eax
...
80106bf4:	0f 84 c2 00 00 00    	je     80106cbc <switchuvm+0xec>
  pushcli();
80106bfa:	e8 51 d9 ff ff       	call   80104550 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106bff:	e8 0c cd ff ff       	call   80103910 <mycpu>
80106c04:	89 c3                	mov    %eax,%ebx
80106c06:	e8 05 cd ff ff       	call   80103910 <mycpu>
80106c0b:	89 c7                	mov    %eax,%edi
80106c0d:	e8 fe cc ff ff       	call   80103910 <mycpu>
80106c12:	83 c7 08             	add    $0x8,%edi
80106c15:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c18:	e8 f3 cc ff ff       	call   80103910 <mycpu>
...
80106c61:	e8 aa cc ff ff       	call   80103910 <mycpu>
...
80106c7f:	e8 8c cc ff ff       	call   80103910 <mycpu>
80106c84:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c87:	e8 84 cc ff ff       	call   80103910 <mycpu>
...
80106d0f:	e8 4c da ff ff       	call   80104760 <memset>
...
80106d42:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d43:	e9 b8 da ff ff       	jmp    80104800 <memmove>
    panic("inituvm: more than a page");
80106d48:	83 ec 0c             	sub    $0xc,%esp
80106d4b:	68 5d 7e 10 80       	push   $0x80107e5d
...
80106db0:	68 77 7e 10 80       	push   $0x80107e77
...
80106e38:	68 18 7f 10 80       	push   $0x80107f18
...
80106e9b:	e8 c0 d8 ff ff       	call   80104760 <memset>
...
80106ed9:	68 95 7e 10 80       	push   $0x80107e95
...
80106f3b:	68 ad 7e 10 80       	push   $0x80107ead
...
8010701c:	68 c9 7e 10 80       	push   $0x80107ec9
...
80107050:	e8 0b d7 ff ff       	call   80104760 <memset>
...
801070bb:	a3 c4 46 11 80       	mov    %eax,0x801146c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801070ec:	68 da 7e 10 80       	push   $0x80107eda
...
80107162:	68 e4 7e 10 80       	push   $0x80107ee4
...
801071c0:	e8 3b d6 ff ff       	call   80104800 <memmove>
...
80107237:	68 fe 7e 10 80       	push   $0x80107efe
...
801072f0:	e8 0b d5 ff ff       	call   80104800 <memmove>
    len -= n;
    buf += n;
...
80107381:	b8 e4 46 11 80       	mov    $0x801146e4,%eax
...
8010738b:	89 15 e0 46 11 80    	mov    %edx,0x801146e0
    for (mti=1; mti<N; mti++)
80107391:	eb 08                	jmp    8010739b <sgenrand+0x1b>
80107393:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107397:	90                   	nop
80107398:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
8010739b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
801073a1:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
801073a3:	3d 9c 50 11 80       	cmp    $0x8011509c,%eax
801073a8:	75 ee                	jne    80107398 <sgenrand+0x18>
801073aa:	c7 05 60 a4 10 80 70 	movl   $0x270,0x8010a460
801073b1:	02 00 00 
}
801073b4:	5d                   	pop    %ebp
801073b5:	c3                   	ret    
...
801073c0:	a1 60 a4 10 80       	mov    0x8010a460,%eax
801073c5:	3d 6f 02 00 00       	cmp    $0x26f,%eax
801073ca:	7f 3d                	jg     80107409 <genrand+0x49>
    ...
    y = mt[mti++];
801073cc:	8b 0c 85 e0 46 11 80 	mov    -0x7feeb920(,%eax,4),%ecx
801073d3:	8d 50 01             	lea    0x1(%eax),%edx
801073d6:	89 15 60 a4 10 80    	mov    %edx,0x8010a460
    y ^= TEMPERING_SHIFT_U(y);
801073dc:	89 ca                	mov    %ecx,%edx
801073de:	c1 ea 0b             	shr    $0xb,%edx
801073e1:	31 ca                	xor    %ecx,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
801073e3:	89 d0                	mov    %edx,%eax
801073e5:	c1 e0 07             	shl    $0x7,%eax
801073e8:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
801073ed:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
801073ef:	89 c2                	mov    %eax,%edx
801073f1:	c1 e2 0f             	shl    $0xf,%edx
801073f4:	81 e2 00 00 c6 ef    	and    $0xefc60000,%edx
801073fa:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_L(y);
801073fc:	89 d0                	mov    %edx,%eax
801073fe:	c1 e8 12             	shr    $0x12,%eax
80107401:	31 d0                	xor    %edx,%eax

    // Strip off uppermost bit because we want a long,
    // not an unsigned long
    return y & RAND_MAX;
80107403:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
80107408:	c3                   	ret    
        if (mti == N+1)   /* if sgenrand() has not been called, */
80107409:	3d 71 02 00 00       	cmp    $0x271,%eax
8010740e:	0f 84 d4 00 00 00    	je     801074e8 <genrand+0x128>
    mt[0]= seed & 0xffffffff;
80107414:	31 c0                	xor    %eax,%eax
80107416:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010741d:	8d 76 00             	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80107420:	8b 0c 85 e0 46 11 80 	mov    -0x7feeb920(,%eax,4),%ecx
80107427:	83 c0 01             	add    $0x1,%eax
8010742a:	8b 14 85 e0 46 11 80 	mov    -0x7feeb920(,%eax,4),%edx
80107431:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
80107437:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
8010743d:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
8010743f:	89 d1                	mov    %edx,%ecx
80107441:	83 e2 01             	and    $0x1,%edx
80107444:	d1 e9                	shr    %ecx
80107446:	33 0c 85 10 4d 11 80 	xor    -0x7feeb2f0(,%eax,4),%ecx
8010744d:	33 0c 95 3c 7f 10 80 	xor    -0x7fef80c4(,%edx,4),%ecx
80107454:	89 0c 85 dc 46 11 80 	mov    %ecx,-0x7feeb924(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
8010745b:	3d e3 00 00 00       	cmp    $0xe3,%eax
80107460:	75 be                	jne    80107420 <genrand+0x60>
80107462:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80107468:	8b 0c 85 e0 46 11 80 	mov    -0x7feeb920(,%eax,4),%ecx
8010746f:	83 c0 01             	add    $0x1,%eax
80107472:	8b 14 85 e0 46 11 80 	mov    -0x7feeb920(,%eax,4),%edx
80107479:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
8010747f:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
80107485:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
80107487:	89 d1                	mov    %edx,%ecx
80107489:	83 e2 01             	and    $0x1,%edx
8010748c:	d1 e9                	shr    %ecx
8010748e:	33 0c 85 50 43 11 80 	xor    -0x7feebcb0(,%eax,4),%ecx
80107495:	33 0c 95 3c 7f 10 80 	xor    -0x7fef80c4(,%edx,4),%ecx
8010749c:	89 0c 85 dc 46 11 80 	mov    %ecx,-0x7feeb924(,%eax,4)
        for (;kk<N-1;kk++) {
801074a3:	3d 6f 02 00 00       	cmp    $0x26f,%eax
801074a8:	75 be                	jne    80107468 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
801074aa:	8b 0d e0 46 11 80    	mov    0x801146e0,%ecx
801074b0:	a1 9c 50 11 80       	mov    0x8011509c,%eax
801074b5:	89 ca                	mov    %ecx,%edx
801074b7:	25 00 00 00 80       	and    $0x80000000,%eax
801074bc:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
801074c2:	09 d0                	or     %edx,%eax
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
801074c4:	89 c2                	mov    %eax,%edx
801074c6:	83 e0 01             	and    $0x1,%eax
801074c9:	d1 ea                	shr    %edx
801074cb:	33 15 10 4d 11 80    	xor    0x80114d10,%edx
801074d1:	33 14 85 3c 7f 10 80 	xor    -0x7fef80c4(,%eax,4),%edx
801074d8:	89 15 9c 50 11 80    	mov    %edx,0x8011509c
801074de:	ba 01 00 00 00       	mov    $0x1,%edx
801074e3:	e9 ee fe ff ff       	jmp    801073d6 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
801074e8:	b8 e4 46 11 80       	mov    $0x801146e4,%eax
801074ed:	b9 9c 50 11 80       	mov    $0x8011509c,%ecx
801074f2:	ba 05 11 00 00       	mov    $0x1105,%edx
801074f7:	c7 05 e0 46 11 80 05 	movl   $0x1105,0x801146e0
801074fe:	11 00 00 
    for (mti=1; mti<N; mti++)
80107501:	eb 08                	jmp    8010750b <genrand+0x14b>
80107503:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107507:	90                   	nop
80107508:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
8010750b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
80107511:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
80107513:	39 c1                	cmp    %eax,%ecx
80107515:	75 f1                	jne    80107508 <genrand+0x148>
80107517:	e9 f8 fe ff ff       	jmp    80107414 <genrand+0x54>
...
8010753a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
   x = genrand();
80107540:	e8 7b fe ff ff       	call   801073c0 <genrand>
  while (num_rand - defect <= (unsigned long)x);
